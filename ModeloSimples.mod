...
//. 3-4: Definition of (gross) inflation
...
//. 8: Law of Motion for domestic Prices
...
//11 international investor First Order Condition 
binv = exp(s)/(exp(s(+1))*exp(Rstar)) - 1/exp(R);
